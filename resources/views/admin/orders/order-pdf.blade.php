      ...
      <div class="card p-2">
          ...
          <div class="card-body">
            <table class="table align-items-center mb-0"  style="width:100%; !important">
                <thead>
                  <tr>
                    <th class="text-center text-uppercase text-secondary  opacity-7"> Rekanan</th>
                    <th class="text-center text-uppercase text-secondary  opacity-7"> Anak</th>
                    <th class="text-center text-uppercase text-secondary  opacity-7"> Ayah</th>
                    ...
                    <th class="text-center text-uppercase text-secondary opacity-7">Total </th>
                  </tr>
                </thead>
                <tbody>
